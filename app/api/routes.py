...
async def config(request: Request):
    ...
    return ConfigResponse(
        ...
        enable_dynamic_universe=settings.enable_dynamic_universe,
        universe_refresh_seconds=settings.universe_refresh_seconds,
        universe_quote_currency=settings.universe_quote_currency,
        universe_excluded_symbols=settings.universe_excluded_symbols,
        universe_max_symbols=settings.universe_max_symbols,
        universe_require_tradable=settings.universe_require_tradable,
        universe_persist_cache=settings.universe_persist_cache,
        default_timeframe=settings.default_timeframe,
        scan_interval_seconds=settings.scan_interval_seconds,
        max_symbols_per_scan=settings.max_symbols_per_scan,
        top_candidates_per_scan=settings.top_candidates_per_scan,
        bar_batch_size=settings.bar_batch_size,
        bar_batch_max_retries=settings.bar_batch_max_retries,
        ...
        exclude_cooldown_symbols_from_prefilter=settings.exclude_cooldown_symbols_from_prefilter,
        exclude_existing_positions_from_prefilter=settings.exclude_existing_positions_from_prefilter,
        exclude_open_order_symbols_from_prefilter=settings.exclude_open_order_symbols_from_prefilter,
        rank_by_trend_weight=settings.rank_by_trend_weight,
        rank_by_volume_weight=settings.rank_by_volume_weight,
        rank_by_volatility_weight=settings.rank_by_volatility_weight,
        rank_by_momentum_weight=settings.rank_by_momentum_weight,
